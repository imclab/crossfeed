# Locate SimGear for fgx-cf project
# This module defines
...
message(STATUS "*** SimGear include directory: SIMGEAR_INCLUDE_DIR=${SIMGEAR_INCLUDE_DIR}")
...
if((NOT SIMGEAR_CORE_LIBRARIES)OR(NOT SIMGEAR_LIBRARIES))
    ...
    message(STATUS "*** found SimGear libraries SIMGEAR_CORE_LIBRARIES=${SIMGEAR_CORE_LIBRARIES}")
endif()
...
else (NOT NO_SG_VERSION_CHECK)
include(FindPackageHandleStandardArgs)
FIND_PACKAGE_HANDLE_STANDARD_ARGS(SimGear DEFAULT_MSG
     SIMGEAR_LIBRARIES SIMGEAR_CORE_LIBRARIES SIMGEAR_INCLUDE_DIR)
